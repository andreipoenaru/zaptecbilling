...
from swagger_codegen_fork.parsing.data_type import DataType
...
class PackageRenderer(Renderer):
    def __init__(
        ...
        self._package_api_lib_module_name = f"swagger_codegen_fork.{self._package_api_lib_name}"
    ...
    def render(self, endpoints: List[EndpointDescription]):
        ...
        self._render_low_level_lib("swagger_codegen_fork")
