...
from swagger_codegen_fork.cli.config import load_config
from swagger_codegen_fork.cli.imports import import_class, qualname
from swagger_codegen_fork.cli.setup_renderer import setup_renderer
from swagger_codegen_fork.parsing.endpoint import EndpointDescription
from swagger_codegen_fork.parsing.loaders import load_base_schema
from swagger_codegen_fork.parsing.parse import endpoints_from_base_schema
from swagger_codegen_fork.render.renderers.package import PackageRenderer
...
@app.command()
def build(config: str = ".swagger_codegen_fork.toml"):
    ...
    endpoint_import_path = cfg.get("swagger_codegen_fork", {}).get("endpoint")
    renderer_import_path = cfg.get("swagger_codegen_fork", {}).get("renderer")
